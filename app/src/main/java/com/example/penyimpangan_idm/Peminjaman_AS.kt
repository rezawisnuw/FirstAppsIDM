        ...
        button3!!.setOnClickListener(object : View.OnClickListener {
            ...
            override fun onClick(v: View) {
                if(Tktujuan == ""){
                    ...
                    pb_peminjamanAS.visibility = View.GONE
                    getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
                    val dialog0 = AlertDialog.Builder(this@Peminjaman_AS)
                    dialog0.setTitle("Submit Gagal!")
                    dialog0.setMessage("Data Tidak Lengkap")
                    dialog0.setNegativeButton("Kembali", DialogInterface.OnClickListener{ dialog, which ->
                        Toast.makeText(
                            this@Peminjaman_AS,
                            "Gagal Tersubmit",
